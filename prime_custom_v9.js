(function(){
  ...
  function primeCommercialDoc(obj,kind){
    ...
    return '<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">'+
      ...
      '@media(max-width:650px){body{padding:0}.page{border-radius:0;border:0}.brandhead{padding:14px 16px}.phoneMark{width:40px;height:62px}.bolt{font-size:38px;left:6px;top:12px}.phoneMark:before{left:8px}.brandlock{gap:10px}.brandWord strong{font-size:25px}.brandWord small{font-size:8px;letter-spacing:.18em}.company{display:none}.content{padding:20px 16px}.grid{grid-template-columns:1fr 1fr}.clientmeta{grid-template-columns:1fr}.dochead h1{font-size:25px}.sumrow{display:block}.totalboxdoc{min-width:0;width:100%}}'+
