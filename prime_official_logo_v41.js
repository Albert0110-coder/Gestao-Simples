(function(){
  ...
  function injectStyle(){
    if(document.getElementById('primeOfficialLogoStyleV41'))return;
    ['primeOfficialLogoStyleV37','primeOfficialLogoStyleV38','primeOfficialLogoStyleV39','primeOfficialLogoStyleV40'].forEach(function(id){var old=document.getElementById(id);if(old)old.remove()});
    var style=document.createElement('style');
    style.id='primeOfficialLogoStyleV41';
  ...
  if(typeof previousCommercialDoc==='function'){
    window.commercialDoc=function(obj,kind){
      ...
      var src=logoUrl();
      var official='<header class="brandhead official-brandhead-v41"><img class="official-receipt-logo-v41" src="'+src+'" onerror="this.onerror=null;this.src=\''+fallbackLogo+'\'" alt="Prime"><div class="company"><span>Atendimento e serviços</span><span class="phone">WhatsApp: (93) 98436-5610</span></div></header><div class="accent"></div>';
      html=String(html||'').replace(/<header class="brandhead">[\s\S]*?<\/header><div class="accent"><\/div>/i,official);
      html=html.replace('</style>','.official-brandhead-v41{min-height:150px!important;padding:12px 24px!important}.official-receipt-logo-v41{display:block;width:270px;max-width:62%;height:auto;object-fit:contain;background:transparent!important}@media(max-width:650px){.official-brandhead-v41{min-height:112px!important;padding:10px 14px!important}.official-receipt-logo-v41{width:230px;max-width:100%}}@media print{.official-brandhead-v41{min-height:138px!important}.official-receipt-logo-v41{width:250px}}</style>');
      return html;
    };
  }
